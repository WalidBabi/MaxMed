...
Route::middleware(['guest', \App\Http\Middleware\PreventBackHistory::class])->group(function () {
    ...
    // Supplier Invitation Direct Onboarding Route
    Route::get('supplier/invitation/{token}', [SupplierRegistrationController::class, 'invitationOnboarding'])
        ->name('supplier.invitation.onboarding');
});
