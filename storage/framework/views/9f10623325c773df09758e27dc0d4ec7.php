                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="type" id="type" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        <option value="proforma" <?php echo e(old('type', 'proforma') == 'proforma' ? 'selected' : ''); ?>>Proforma Invoice</option>
                                        <option value="final" <?php echo e(old('type') == 'final' ? 'selected' : ''); ?>>Final Invoice</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <input type="hidden" name="customer_name" id="customer_name_hidden" value="<?php echo e(old('customer_name', $quote->customer_name ?? '')); ?>">
                                </div>
                                <div>
                                    <label for="invoice_date" class="block text-sm font-medium text-gray-700 mb-2">Invoice Date</label>
                                    <input type="date" id="invoice_date" name="invoice_date" 
                                           value="<?php echo e(old('invoice_date', now()->format('Y-m-d'))); ?>" required
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                                <div>
                                    <label for="due_date" class="block text-sm font-medium text-gray-700 mb-2">Due Date</label>
                                    <input type="date" id="due_date" name="due_date" 
                                           value="<?php echo e(old('due_date', now()->addDays(30)->format('Y-m-d'))); ?>" required
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                                <div>
                                    <label for="reference_number" class="block text-sm font-medium text-gray-700 mb-2">Reference Number</label>
                                    <input type="text" id="reference_number" name="reference_number" 
                                           value="<?php echo e(old('reference_number', $quote->reference_number ?? '')); ?>"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="shipping_rate" name="shipping_rate" step="0.01" min="0"
                                           value="<?php echo e(old('shipping_rate', $quote->shipping_rate ?? 0)); ?>"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm <?php $__errorArgs = ['shipping_rate'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="vat_rate" name="vat_rate" step="0.01" min="0" max="100"
                                           value="<?php echo e(old('vat_rate', $quote->vat_rate ?? 0)); ?>"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                           onchange="updateShippingAmount()" 
                                ...
                                <div>
                                    ...
                                    <input type="number" id="customs_clearance_fee" name="customs_clearance_fee" step="0.01" min="0"
                                           value="<?php echo e(old('customs_clearance_fee', $quote->customs_clearance_fee ?? 0)); ?>"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                           onchange="updateShippingAmount()" 
                                           oninput="this.setAttribute('data-manual-override', 'true')"
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea id="billing_address" name="billing_address" rows="3" required
                                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?php echo e(old('billing_address')); ?></textarea>
                                ...
                                <div>
                                    ...
                                    <textarea id="shipping_address" name="shipping_address" rows="3"
                                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?php echo e(old('shipping_address')); ?></textarea>
                                    <p class="mt-1 text-xs text-gray-500">This will be automatically filled when you select a customer</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select name="payment_terms" id="payment_terms" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        <option value="advance_50" <?php echo e(old('payment_terms', 'advance_50') == 'advance_50' ? 'selected' : ''); ?>>50% Advance Payment</option>
                                        <option value="advance_100" <?php echo e(old('payment_terms') == 'advance_100' ? 'selected' : ''); ?>>100% Advance Payment</option>
                                        <option value="on_delivery" <?php echo e(old('payment_terms') == 'on_delivery' ? 'selected' : ''); ?>>Cash On Delivery</option>
                                        <option value="net_30" <?php echo e(old('payment_terms') == 'net_30' ? 'selected' : ''); ?>>Net 30 Days</option>
                                        <option value="custom" <?php echo e(old('payment_terms') == 'custom' ? 'selected' : ''); ?>>Custom Terms</option>
                                    </select>
                                </div>
                                <div id="custom-percentage" style="display: none;">
                                    ...
                                    <input type="number" id="advance_percentage" name="advance_percentage" min="0" max="100" step="0.01" 
                                           value="<?php echo e(old('advance_percentage')); ?>"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="overflow-x-auto w-full">
                            <table class="w-full divide-y divide-gray-200 items-table">
                                ...
                                <tbody id="itemsTable" class="bg-white divide-y divide-gray-200">
                                    <?php if($quote && $quote->items->count() > 0): ?>
                                        ...
                                        <tr class="item-row bg-white hover:bg-gray-50" draggable="true">
                                            ...
                                            <td class="px-3 py-4">
                                                <div class="relative product-dropdown-container">
                                                    <input type="text" 
                                                           ...
                                                           value="<?php echo e($item->item_details); ?>"
                                                           autocomplete="off">
                                                    <input type="hidden" name="items[<?php echo e($index); ?>][product_id]" class="product-id-input" value="<?php echo e($item->product_id ?? ''); ?>">
                                                    <input type="hidden" name="items[<?php echo e($index); ?>][description]" class="item-details-hidden" value="<?php echo e($item->item_details); ?>">
                                            ...
                                            <td class="px-3 py-4">
                                                <div class="relative specifications-dropdown-container">
                                                    <input type="text" 
                                                           ...
                                                           autocomplete="off"
                                                           readonly>
                                                    <input type="hidden" name="items[<?php echo e($index); ?>][specifications]" class="specifications-hidden">
                                                    
                                                    <!-- Size Options Dropdown -->
                                                    <div class="mt-2">
                                                        <select name="items[<?php echo e($index); ?>][size]" class="block w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 size-options-select">
                                            ...
                                            <td class="px-3 py-4">
                                                <input type="number" step="0.01" name="items[<?php echo e($index); ?>][unit_price]" value="<?php echo e($item->rate); ?>" required
                                            ...
                                            <td class="px-3 py-4">
                                                <div class="flex">
                                                    <input type="number" step="0.01" name="items[<?php echo e($index); ?>][discount_percentage]" value="<?php echo e($item->discount); ?>" min="0" max="100"
                                            ...
                                            <td class="px-3 py-4 text-right">
                                                <span class="amount-display font-medium text-gray-900"><?php echo e(number_format($item->amount, 2)); ?></span>
                                                <input type="hidden" name="items[<?php echo e($index); ?>][line_total]" value="<?php echo e($item->amount); ?>">
                                            </td>
                                            <td class="px-3 py-4 text-center">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="3"
                                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?php echo e(old('description', $quote->subject ?? '')); ?></textarea>
                                </div>
                                <div>
                                    ...
                                    <textarea id="terms_conditions" name="terms_conditions" rows="3"
                                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?php echo e(old('terms_conditions', $quote->terms_conditions ?? '')); ?></textarea>
                                </div>
                                <div>
                                    <label for="notes" class="block text-sm font-medium text-gray-700 mb-2">Notes</label>
                                    <textarea id="notes" name="notes" rows="3"
                                              class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?php echo e(old('notes', $quote->customer_notes ?? '')); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/admin/invoices/create.blade.php ENDPATH**/ ?>