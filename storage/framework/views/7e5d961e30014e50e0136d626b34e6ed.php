<?php $__env->startSection('title', 'Deliveries Management'); ?>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('admin.deliveries.create')); ?>" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">
                            ...
                            <?php $__currentLoopData = $deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($delivery->delivery_number ?? 'DL-' . str_pad($delivery->id, 6, '0', STR_PAD_LEFT)); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($delivery->order): ?>
                                            <a href="<?php echo e(route('admin.orders.show', $delivery->order)); ?>" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">
                                                <?php echo e($delivery->order->order_number); ?>

                                            </a>
                                        <?php else: ?>
                                            <span class="text-sm text-red-600">
                                                #<?php echo e($delivery->order_id); ?> (Order not found)
                                            </span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($delivery->order && $delivery->order->user): ?>
                                            <div class="text-sm text-gray-900">
                                                <div class="font-medium"><?php echo e($delivery->order->user->name); ?></div>
                                                <?php if($delivery->order->user->company_name): ?>
                                                    <div class="text-gray-500"><?php echo e($delivery->order->user->company_name); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        <?php elseif($delivery->order): ?>
                                            <div class="text-sm text-gray-900">
                                                <div class="font-medium"><?php echo e($delivery->order->customer_name ?? 'N/A'); ?></div>
                                                <?php if($delivery->order->customer_company): ?>
                                                    <div class="text-gray-500"><?php echo e($delivery->order->customer_company); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        ?>
                                        <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium <?php echo e($status[0]); ?> <?php echo e($status[1]); ?>">
                                            <?php echo e(ucfirst(str_replace('_', ' ', $delivery->status))); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($hasFinalInvoice): ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900"><?php echo e($delivery->tracking_number ?? 'N/A'); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900"><?php echo e($delivery->carrier ?? 'N/A'); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-500"><?php echo e($delivery->shipped_at?->format('M d, Y H:i') ?? 'Not shipped'); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            <a href="<?php echo e(route('admin.deliveries.show', $delivery)); ?>" class="text-indigo-600 hover:text-indigo-900" title="View Delivery">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                                </svg>
                                            </a>
                                            <a href="<?php echo e(route('admin.deliveries.edit', $delivery)); ?>" class="text-green-600 hover:text-green-900" title="Edit Delivery">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <?php if($canConvert): ?>
                                                <form action="<?php echo e(route('admin.deliveries.convert-to-final-invoice', $delivery)); ?>" method="POST" class="inline" onsubmit="return confirm('Convert proforma invoice to final invoice?');">
                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <a href="<?php echo e(route('admin.deliveries.pdf', $delivery)); ?>" class="text-blue-600 hover:text-blue-900" title="Download Delivery Note PDF">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                                </svg>
                                            </a>
                                            
                                            <form action="<?php echo e(route('admin.deliveries.destroy', $delivery)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this delivery?');">
                                                <?php echo csrf_field(); ?>
                ...
                <?php if($deliveries->hasPages()): ?>
                    <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
                        <div class="flex-1 flex justify-between sm:hidden">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e($deliveries->previousPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                    Previous
                                </a>
                            <?php endif; ?>

                            <?php if($deliveries->hasMorePages()): ?>
                                <a href="<?php echo e($deliveries->nextPageUrl()); ?>" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                    Next
                                </a>
                            <?php else: ?>
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700">
                                    Showing
                                    <span class="font-medium"><?php echo e($deliveries->firstItem()); ?></span>
                                    to
                                    <span class="font-medium"><?php echo e($deliveries->lastItem()); ?></span>
                                    of
                                    <span class="font-medium"><?php echo e($deliveries->total()); ?></span>
                                    results
                                </p>
                            </div>
                            <div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/admin/deliveries/index.blade.php ENDPATH**/ ?>