    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                <a href="<?php echo e(route('admin.purchase-orders.index', ['status' => 'all'])); ?>" 
                   class="<?php if($status === 'all'): ?> border-indigo-500 text-indigo-600 <?php else: ?> border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 <?php endif; ?> whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    All Orders
                    <span class="<?php if($status === 'all'): ?> bg-indigo-100 text-indigo-600 <?php else: ?> bg-gray-100 text-gray-900 <?php endif; ?> ml-2 py-0.5 px-2.5 rounded-full text-xs font-medium"><?php echo e($statusCounts['all']); ?></span>
                </a>
                
                <a href="<?php echo e(route('admin.purchase-orders.index', ['status' => 'draft'])); ?>" 
                   class="<?php if($status === 'draft'): ?> border-gray-500 text-gray-600 <?php else: ?> border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 <?php endif; ?> whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    Draft
                    <span class="<?php if($status === 'draft'): ?> bg-gray-100 text-gray-600 <?php else: ?> bg-gray-100 text-gray-900 <?php endif; ?> ml-2 py-0.5 px-2.5 rounded-full text-xs font-medium"><?php echo e($statusCounts['draft']); ?></span>
                </a>
                
                <a href="<?php echo e(route('admin.purchase-orders.index', ['status' => 'sent_to_supplier'])); ?>" 
                   class="<?php if($status === 'sent_to_supplier'): ?> border-blue-500 text-blue-600 <?php else: ?> border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 <?php endif; ?> whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    Sent to Supplier
                    <span class="<?php if($status === 'sent_to_supplier'): ?> bg-blue-100 text-blue-600 <?php else: ?> bg-gray-100 text-gray-900 <?php endif; ?> ml-2 py-0.5 px-2.5 rounded-full text-xs font-medium"><?php echo e($statusCounts['sent_to_supplier']); ?></span>
                </a>
                
                <a href="<?php echo e(route('admin.purchase-orders.index', ['status' => 'acknowledged'])); ?>" 
                   class="<?php if($status === 'acknowledged'): ?> border-yellow-500 text-yellow-600 <?php else: ?> border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 <?php endif; ?> whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    Acknowledged
                    <span class="<?php if($status === 'acknowledged'): ?> bg-yellow-100 text-yellow-600 <?php else: ?> bg-gray-100 text-gray-900 <?php endif; ?> ml-2 py-0.5 px-2.5 rounded-full text-xs font-medium"><?php echo e($statusCounts['acknowledged']); ?></span>
                </a>
                
                <a href="<?php echo e(route('admin.purchase-orders.index', ['status' => 'in_production'])); ?>" 
                   class="<?php if($status === 'in_production'): ?> border-purple-500 text-purple-600 <?php else: ?> border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 <?php endif; ?> whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    In Production
                    <span class="<?php if($status === 'in_production'): ?> bg-purple-100 text-purple-600 <?php else: ?> bg-gray-100 text-gray-900 <?php endif; ?> ml-2 py-0.5 px-2.5 rounded-full text-xs font-medium"><?php echo e($statusCounts['in_production']); ?></span>
                </a>
                
                <a href="<?php echo e(route('admin.purchase-orders.index', ['status' => 'completed'])); ?>" 
                   class="<?php if($status === 'completed'): ?> border-green-500 text-green-600 <?php else: ?> border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 <?php endif; ?> whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
                    Completed
                    <span class="<?php if($status === 'completed'): ?> bg-green-100 text-green-600 <?php else: ?> bg-gray-100 text-gray-900 <?php endif; ?> ml-2 py-0.5 px-2.5 rounded-full text-xs font-medium"><?php echo e($statusCounts['completed']); ?></span>
                </a>
            </nav>
        </div>
    </div>
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <h3 class="text-lg font-semibold text-gray-900">
                    <?php if($status === 'all'): ?>
                        All Purchase Orders
                    <?php else: ?>
                        <?php echo e(ucfirst(str_replace('_', ' ', $status))); ?> Purchase Orders
                    <?php endif; ?>
                    <span class="text-gray-500 font-normal">(<?php echo e($purchaseOrders->total()); ?> total)</span>
                </h3>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-3 py-3 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div>
                                            <div class="text-xs font-medium text-gray-900"><?php echo e($po->po_number); ?></div>
                                            <div class="text-xs text-gray-500"><?php echo e(formatDubaiDate($po->po_date, 'M d, Y')); ?></div>
                                        </div>
                                    </div>
                                </td>
                                
                                <td class="px-3 py-3 whitespace-nowrap">
                                    <?php if($po->hasCustomerOrder()): ?>
                                        <div class="text-xs font-medium text-gray-900">
                                            <a href="<?php echo e(route('admin.orders.show', $po->order)); ?>" class="text-indigo-600 hover:text-indigo-700">
                                                <?php echo e($po->order->order_number); ?>

                                            </a>
                                        </div>
                                        <div class="text-xs text-gray-500"><?php echo e($po->order->getCustomerName()); ?></div>
                                        <div class="text-xs text-gray-400">Customer Order</div>
                                    <?php elseif($po->isFromSupplierInquiry()): ?>
                                        <div class="text-xs font-medium text-gray-900">Inquiry #<?php echo e($po->supplier_quotation_id); ?></div>
                                        <?php if($po->supplierQuotation && $po->supplierQuotation->product): ?>
                                            <div class="text-xs text-gray-500"><?php echo e($po->supplierQuotation->product->name); ?></div>
                                        <?php endif; ?>
                                ...
                                <td class="px-3 py-3 whitespace-nowrap">
                                    <div class="text-xs font-medium text-gray-900"><?php echo e($po->supplier_name); ?></div>
                                    <?php if($po->supplier_email): ?>
                                        <div class="text-xs text-gray-500"><?php echo e($po->supplier_email); ?></div>
                                    <?php endif; ?>
                                </td>
                                
                                <td class="px-3 py-3 whitespace-nowrap">
                                    <div class="text-xs font-medium text-gray-900"><?php echo e($po->currency); ?> <?php echo e($po->formatted_total); ?></div>
                                    <?php if($po->paid_amount > 0): ?>
                                        <div class="text-xs text-gray-500">Paid: <?php echo e($po->currency); ?> <?php echo e($po->formatted_paid_amount); ?></div>
                                    <?php endif; ?>
                                </td>
                                
                                <td class="px-3 py-3 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($po->status_badge_class); ?>">
                                        <?php echo e(\App\Models\PurchaseOrder::$statuses[$po->status] ?? ucfirst($po->status)); ?>

                                    </span>
                                </td>
                                
                                <td class="px-3 py-3 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($po->payment_status_badge_class); ?>">
                                        <?php echo e(\App\Models\PurchaseOrder::$paymentStatuses[$po->payment_status] ?? ucfirst($po->payment_status)); ?>
                                ...
                                <td class="px-3 py-3 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-1">
                                        <a href="<?php echo e(route('admin.purchase-orders.show', $po)); ?>" class="text-indigo-600 hover:text-indigo-900" title="View Purchase Order">
                                        ...
                                        <?php if($po->canBeEdited()): ?>
                                            <a href="<?php echo e(route('admin.purchase-orders.edit', $po)); ?>" class="text-green-600 hover:text-green-900" title="Edit Purchase Order<?php echo e($po->status !== 'draft' ? ' (Sent)' : ''); ?>">
                                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <button class="text-blue-600 hover:text-blue-900 send-email-btn" 
                                                ...
                                                data-supplier-name="<?php echo e($po->supplier_name); ?>"
                                                data-po-number="<?php echo e($po->po_number); ?>"
                                                data-supplier-email="<?php echo e($po->supplier_email ?? ''); ?>"
                                                data-attachments="<?php echo e(is_array($po->attachments) ? json_encode($po->attachments) : '[]'); ?>"
                                                title="Send Email">
                                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <a href="<?php echo e(route('admin.purchase-orders.pdf', $po)); ?>" class="text-red-600 hover:text-red-900" title="Download PDF">
                                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                            </svg>
                                        </a>
                                        
                                        <?php if($po->payment_status === 'pending' || $po->payment_status === 'partial'): ?>
                                            <a href="<?php echo e(route('admin.purchase-orders.show', $po)); ?>#payment" class="text-green-600 hover:text-green-900" title="Record Payment">
                                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <?php if($po->canBeEdited()): ?>
                                            <form action="<?php echo e(route('admin.purchase-orders.destroy', $po)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this purchase order?<?php echo e($po->status !== 'draft' ? ' Note: This purchase order has already been sent to the supplier.' : ''); ?> This action cannot be undone.')">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit" class="text-red-600 hover:text-red-900" title="Delete Purchase Order<?php echo e($po->status !== 'draft' ? ' (Sent)' : ''); ?>">
                                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/admin/purchase-orders/index.blade.php ENDPATH**/ ?>