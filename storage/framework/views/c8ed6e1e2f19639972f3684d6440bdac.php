...
<head>
    ...
    <title><?php echo e($type === 'registered' ? 'New User Registration' : 'User Login Activity'); ?> - MaxMed</title>
    <!--[if mso]>
    <noscript>
        <xml>
                        ...
                        <td style="background-color: #FFFFFF; padding: 40px 30px; text-align: center; border-bottom: 2px solid #171e60;">
                            ...
                            <![endif]-->
                                        ...
                                        <h1 style="margin: 0 0 8px 0; font-size: 28px; font-weight: 600; color: #171e60; letter-spacing: -0.5px;">
                                            <?php echo e($type === 'registered' ? '👤 New User Registration' : '🔐 User Login Activity'); ?>
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 0; color: #2D3748; line-height: 1.6;">
                                            A new user has successfully registered on MaxMed. Please review the registration details below.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        <div style="font-weight: 600; color: #D97706; margin-bottom: 8px; font-size: 16px;">
                                            🔐 User Login Activity Alert
                                        </div>
                                        <p style="margin: 0; color: #2D3748; line-height: 1.6;">
                                            A user has logged into MaxMed. Login activity details are provided below.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        <div style="margin-bottom: 20px;">
                                            <div style="font-size: 20px; font-weight: 700; color: #171e60; margin-bottom: 8px; letter-spacing: -0.5px;">👤 User Information</div>
                                        </div>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; color: #1A202C; font-weight: 600; font-size: 15px;"><?php echo e($user->name); ?></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; color: #1A202C; font-weight: 500; font-size: 15px;">
                                                    <a href="mailto:<?php echo e($user->email); ?>" style="color: #171e60; text-decoration: none;"><?php echo e($user->email); ?></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; font-weight: 600; color: #4A5568; font-size: 15px;">User ID</td>
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; color: #1A202C; font-weight: 500; font-size: 15px;">#<?php echo e($user->id); ?></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; font-weight: 600; color: #4A5568; font-size: 15px;">Time</td>
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; color: #1A202C; font-weight: 500; font-size: 15px;"><?php echo e(now()->toDayDateTimeString()); ?></td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 12px 0; font-weight: 600; color: #4A5568; font-size: 15px;">Method</td>
                                                <td style="padding: 12px 0; color: #1A202C; font-weight: 500; font-size: 15px;"><?php echo e($method); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; margin: 30px 0;">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="<?php echo e($actionUrl); ?>" style="display: inline-block; background-color: #171e60; color: #FFFFFF; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; letter-spacing: 0.5px;">
                                            <?php echo e($type === 'registered' ? 'View User Profile' : 'View Admin Dashboard'); ?>
...
</html> <?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/emails/auth-notification.blade.php ENDPATH**/ ?>