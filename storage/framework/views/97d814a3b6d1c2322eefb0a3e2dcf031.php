...
<?php endif; ?>
    ...
    <div class="mt-6 text-center">
        ...
        <p class="mt-2 text-sm text-gray-600">
            <?php echo e(__('Are you a supplier?')); ?>

            <a href="<?php echo e(route('supplier.register')); ?>" class="font-medium text-indigo-600 hover:text-indigo-500">
                <?php echo e(__('Register as Supplier')); ?>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/auth/login.blade.php ENDPATH**/ ?>