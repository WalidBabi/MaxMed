...
<div class="-mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('admin.products.create')); ?>" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
        ...
        <div class="card-hover overflow-hidden rounded-xl bg-white px-4 py-6 shadow-sm ring-1 ring-gray-900/5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e(App\Models\Product::count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="card-hover overflow-hidden rounded-xl bg-white px-4 py-6 shadow-sm ring-1 ring-gray-900/5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e(App\Models\Product::whereHas('inventory', function($query) { $query->where('quantity', '>', 0); })->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="card-hover overflow-hidden rounded-xl bg-white px-4 py-6 shadow-sm ring-1 ring-gray-900/5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e(App\Models\Category::count()); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-hover rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5 mb-8" 
         x-data="{ filtersOpen: <?php echo e(request()->hasAny(['search', 'category_id', 'brand_id', 'stock_status', 'min_price', 'max_price', 'sort_by', 'sort_order']) ? 'true' : 'false'); ?> }">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <button 
                    ...
                    <?php if(request()->hasAny(['search', 'category_id', 'brand_id', 'stock_status', 'min_price', 'max_price'])): ?>
                        <span class="ml-2 inline-flex items-center rounded-full bg-indigo-100 px-2.5 py-0.5 text-xs font-medium text-indigo-800">
                            <?php echo e(count(array_filter(request()->only(['search', 'category_id', 'brand_id', 'stock_status', 'min_price', 'max_price'])))); ?>
        ...
        <div x-show="filtersOpen" 
             ...
             class="p-6">
            <form action="<?php echo e(route('admin.products.index')); ?>" method="GET" class="space-y-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <div>
                        <label for="search" class="block text-sm font-medium text-gray-700">Search by Name</label>
                        <input type="text" id="search" name="search" value="<?php echo e(request('search')); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Search products...">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="min_price" name="min_price" value="<?php echo e(request('min_price')); ?>" min="0" step="0.01" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="0.00">
                    </div>
                    
                    <div>
                        <label for="max_price" class="block text-sm font-medium text-gray-700">Max Price</label>
                        <input type="number" id="max_price" name="max_price" value="<?php echo e(request('max_price')); ?>" min="0" step="0.01" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="0.00">
                    </div>
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                        <svg class="-ml-0.5 mr-1.5 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card-hover group relative overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5">
                <div class="aspect-h-1 aspect-w-1 w-full overflow-hidden bg-gray-200">
                    <img src="<?php echo e(asset($product->image_url)); ?>" alt="<?php echo e($product->name); ?>" class="h-48 w-full object-cover object-center group-hover:opacity-75">
                    <div class="absolute top-4 right-4">
                        <?php
                            $quantity = $product->inventory ? $product->inventory->quantity : 0;
                        ?>
                        <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium <?php echo e($quantity > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                            <?php echo e($quantity); ?> in stock
                        </span>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <h3 class="text-sm font-medium text-gray-900">
                        <a href="<?php echo e(route('admin.products.show', $product)); ?>" class="absolute inset-0"></a>
                    ...
                    <div class="mt-2 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xs text-gray-400">AED <?php echo e(number_format($product->price_aed, 2)); ?></p>
                            <?php if($product->procurement_price_usd !== null): ?>
                                <p class="text-xs text-gray-400">Proc. USD: $<?php echo e(number_format($product->procurement_price_usd, 2)); ?></p>
                            <?php endif; ?>
                            <?php if($product->procurement_price_aed !== null): ?>
                                <p class="text-xs text-gray-400">Proc. AED: <?php echo e(number_format($product->procurement_price_aed, 2)); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                    
                    <div class="mt-4 flex space-x-2 relative z-10">
                        <a href="<?php echo e(route('admin.products.edit', $product)); ?>" class="flex-1 inline-flex justify-center items-center rounded-md bg-indigo-600 px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        ...
                        <form action="<?php echo e(route('admin.products.destroy', $product)); ?>" method="POST" class="flex-1" onsubmit="return confirm('Are you sure you want to delete this product?');">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="w-full inline-flex justify-center items-center rounded-md bg-red-600 px-3 py-2 text-xs font-semibold text-white shadow-sm hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                                <svg class="-ml-0.5 mr-1.5 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <?php if($products->hasPages()): ?>
        <div class="mt-8 flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
            <div class="flex flex-1 justify-between sm:hidden">
                ...
                <?php else: ?>
                    <a href="<?php echo e($products->previousPageUrl()); ?>" class="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Previous</a>
                <?php endif; ?>
                
                <?php if($products->hasMorePages()): ?>
                    <a href="<?php echo e($products->nextPageUrl()); ?>" class="relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">Next</a>
                <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/admin/products/index.blade.php ENDPATH**/ ?>