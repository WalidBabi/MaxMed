...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="font-sans antialiased bg-gray-50 relative no-select-content">
        ...
        <?php echo $__env->make('components.google-one-tap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('components.google-one-tap-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <script src="<?php echo e(asset('js/google-one-tap.js')); ?>"></script>
