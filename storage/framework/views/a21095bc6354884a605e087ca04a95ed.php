<?php if(isset($seoData)): ?>
    ...
    <?php $__env->startSection('meta_description', $seoData['meta_description']); ?>
    <?php $__env->startSection('meta_keywords', $seoData['meta_keywords']); ?>
<?php elseif(isset($category)): ?>
    <?php $__env->startSection('title', $category->name . ' Laboratory Equipment | MaxMed UAE'); ?>
    <?php $__env->startSection('meta_description', 'Browse ' . $category->name . ' laboratory equipment at MaxMed UAE. Find high-quality scientific instruments and lab supplies in Dubai.'); ?>
<?php elseif(isset($subcategory)): ?>
    <?php $__env->startSection('title', $subcategory->name . ' Laboratory Equipment | MaxMed UAE'); ?>
    <?php $__env->startSection('meta_description', 'Browse ' . $subcategory->name . ' laboratory equipment at MaxMed UAE. Find high-quality scientific instruments and lab supplies in Dubai.'); ?>
<?php elseif(isset($subsubcategory)): ?>
    <?php $__env->startSection('title', $subsubcategory->name . ' Laboratory Equipment | MaxMed UAE'); ?>
    <?php $__env->startSection('meta_description', 'Browse ' . $subsubcategory->name . ' laboratory equipment at MaxMed UAE. Find high-quality scientific instruments and lab supplies in Dubai.'); ?>
<?php elseif(isset($subsubsubcategory)): ?>
    <?php $__env->startSection('title', $subsubsubcategory->name . ' Laboratory Equipment | MaxMed UAE'); ?>
    <?php $__env->startSection('meta_description', 'Browse ' . $subsubsubcategory->name . ' laboratory equipment at MaxMed UAE. Find high-quality scientific instruments and lab supplies in Dubai.'); ?>
<?php endif; ?>

<?php if(isset($emptyCategory)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ai-enhanced-schema','data' => ['category' => $currentCategory,'type' => 'category']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['category' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currentCategory),'type' => 'category']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ai-knowledge-article','data' => ['category' => $currentCategory]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['category' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($currentCategory)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if($isLabEssentials && isset($seoData)): ?>
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "CollectionPage",
  "name": "<?php echo e($seoData['title']); ?>",
  "description": "<?php echo e($seoData['meta_description']); ?>",
  "url": "<?php echo e($seoData['canonical_url']); ?>",
  "provider": {
    "@type": "Organization",
    "name": "MaxMed UAE",
  ...
  "mainEntity": {
    ...
    "numberOfItems": <?php echo e($products->total() ?? 0); ?>
...
<?php if(isset($category) && $category->name === 'Advanced Motion & Scientific Imaging Systems' && isset($seoData)): ?>
<script type="application/ld+json">
{
  "@context": "https://schema.org",
  "@type": "CollectionPage",
...
<div class="container-fluid py-4">
    ...
    <div class="row sidebar-content-container justify-content-center">
        ...
        <div class="col-md-9 mt-2 main-content-column transition-all duration-300">
            ...
            <?php elseif(isset($category) && $category->name === 'Molecular & Clinical Diagnostics'): ?>
            ...
            <?php elseif(isset($category) && $category->name === 'Lab Equipment'): ?>
            ...
            <?php elseif(isset($category) && $category->name === 'Medical Consumables'): ?>
            ...
            <?php elseif(isset($category) && $category->name === 'Life Science & Research'): ?>
            ...
            <?php elseif(isset($category) && $category->name === 'Technology & AI Solutions'): ?>
            ...
            <?php elseif(isset($category) && $category->name === 'Rapid Test Kits & Detection Solutions'): ?>
            ...
            <?php elseif(isset($category) && $category->name === 'Analytical Instruments'): ?>
            ...
            <?php elseif(isset($category) && $category->name === 'Veterinary'): ?>
            ...
            <?php elseif(isset($category) && $category->name === 'Advanced Motion & Scientific Imaging Systems'): ?>
            ...
            <div class="category-header">
                <h1 class="category-title"><?php echo e(isset($category) ? $category->name : 'All Products'); ?></h1>
                <p class="category-description"><?php echo e(isset($category) && $category->description ? $category->description : 'Browse our selection of high-quality products'); ?></p>
            </div>
            <?php endif; ?>
            ...
            <div class="filters-row">
                <div class="product-counter">
                    <div class="counter-text">
                        <span class="counter-number"><?php echo e($products->total()); ?></span>
                        <span class="counter-label"><?php echo e(Str::plural('product', $products->total())); ?> found</span>
                    </div>
                </div>
            </div>
            
            <?php if(session()->missing('pagination_message_shown') && $products->hasPages()): ?>
            ...
            <?php echo e(session(['pagination_message_shown' => true])); ?>
                        ...
                        <div class="masonry-item">
                            <div class="product-item">
                                ...
                                <div class="product-image-container">
                                    <img src="<?php echo e($product->image_url); ?>" class="product-image" alt="<?php echo e($product->name); ?>">
                                </div>
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="product-actions">
                                        <a href="<?php echo e(route('product.show', $product)); ?>" class="btn-action btn-view">
                                            <i class="fas fa-eye"></i> View
                                        </a>
                                        <a href="<?php echo e(route('quotation.form', ['product' => $product->slug])); ?>" class="btn-action btn-quote">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/categories/products.blade.php ENDPATH**/ ?>