<?php $__env->startSection('title', 'Your Laboratory Cart | MaxMed UAE'); ?>
<?php $__env->startSection('meta_description', 'Review and checkout laboratory equipment in your MaxMed UAE shopping cart. Secure payment options for scientific instruments in Dubai.'); ?>
            ...
            <div class="col-lg-8 mb-4">
                <div class="card shadow-lg border-0 rounded-3 overflow-hidden" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px);">
                    <div class="card-header bg-[#171e60] text-white py-3">
                        <h5 class="mb-0"><i class="fas fa-shopping-cart me-2"></i>Cart Items (<?php echo e(count(session('cart'))); ?>)</h5>
                    </div>
                                ...
                                <tr class="border-bottom">
                                    <td class="align-middle fw-semibold">
                                        <div class="d-flex flex-column">
                                            <span class="text-[#171e60]"><?php echo e($item['name']); ?></span>
                                            <small class="text-muted">Item #<?php echo e($id); ?></small>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex align-items-center">
                                            <span class="badge bg-[#171e60] rounded-pill px-3 py-2"><?php echo e($item['quantity']); ?></span>
                                           
                                        </div>
                                    </td>
                                    <td class="align-middle">
                                        <div class="d-flex flex-column">
                                            <span class="text-success fw-bold">$<?php echo e(number_format($item['price'] * $item['quantity'], 2)); ?></span>
                                            <small class="text-muted">$<?php echo e(number_format($item['price'], 2)); ?> each</small>
                                        </div>
                                    </td>
                                    <td class="align-middle">
                ...
                <div class="card shadow-lg border-0 rounded-3 sticky-top" style="top: 20px; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px);">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="fw-bold">
                                $<?php echo e(number_format(array_sum(array_map(function($item) { 
                        ...
                        <form action="<?php echo e(route('stripe.checkout')); ?>" method="POST" id="checkout-form" class="mt-4">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/cart.blade.php ENDPATH**/ ?>