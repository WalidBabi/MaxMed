<div id="cookieConsent" class="fixed bottom-6 left-0 right-0 mx-auto max-w-xl bg-white p-4 shadow-xl rounded-xl border border-gray-200 z-50 hidden" style="">
    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="flex-1 text-gray-800 text-sm md:text-base">
            ...
            <a href="<?php echo e(route('privacy.policy')); ?>" class="text-blue-600 hover:underline ml-1">Learn more</a>
        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/components/cookie-consent.blade.php ENDPATH**/ ?>