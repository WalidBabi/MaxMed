...
<?php $__env->startSection('title', 'Page Not Found - MaxMed UAE'); ?>
<?php $__env->startSection('meta_description', 'The page you are looking for could not be found. Browse our laboratory equipment and medical supplies or contact MaxMed UAE at +971 55 460 2500.'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 text-center">
        ...
        <!-- Search Bar -->
        <div class="mt-8">
            <form method="GET" action="<?php echo e(route('products.index')); ?>" class="flex rounded-lg shadow-sm">
                <input type="text" 
                       name="search" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/errors/404.blade.php ENDPATH**/ ?>