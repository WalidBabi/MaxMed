<?php $__env->startSection('title', $subcategory->name . ' Categories | MaxMed UAE'); ?>

<?php $__env->startSection('meta_description', 'Browse ' . $subcategory->name . ' laboratory equipment subcategories at MaxMed UAE. Find high-quality scientific instruments and lab supplies in Dubai.'); ?>

<?php if(isset($emptyCategory)): ?>
    <?php $__env->startSection('meta_robots', 'noindex, follow'); ?>
<?php endif; ?>

<?php $__env->startSection('meta_keywords', 'laboratory subcategories Dubai, lab equipment UAE, scientific subcategories, laboratory supplies, research lab categories'); ?>
    ...
    <div class="row sidebar-content-container justify-content-center">
        ...
        <div class="col-md-9 mt-2 main-content-column transition-all duration-300">
            <div class="page-header mb-4">
                ...
                <p class="page-description">Browse subcategories of <?php echo e($subcategory->name); ?>. Explore our range of high-quality laboratory equipment and scientific instruments.</p>
            ...
            <div class="subcategory-container">
                ...
                <div class="subcategory-card-wrapper">
                    <a href="<?php echo e($subsubcategory->subcategories->isNotEmpty() ? route('categories.subsubcategory.subsubcategories', [$category, $subcategory, $subsubcategory]) : route('categories.subsubcategory.show', [$category, $subcategory, $subsubcategory])); ?>" class="text-decoration-none">
                        <div class="subcategory-card">
                            <div class="overflow-hidden">
                                <?php if(isset($subsubcategory->image_url)): ?>
                                <img src="<?php echo e($subsubcategory->image_url); ?>" class="card-img-top" alt="<?php echo e($subsubcategory->name); ?>">
                                <?php else: ?>
                                <img src="<?php echo e(asset('images/default-subcategory.jpg')); ?>" class="card-img-top" alt="<?php echo e($subsubcategory->name); ?>">
                                <?php endif; ?>
                            </div>
                            <div class="card-body">
                                <h5 class="card-title"><?php echo e($subsubcategory->name); ?></h5>
                                <?php if($subsubcategory->subcategories->isNotEmpty()): ?>
                                <span class="badge rounded-pill bg-info mt-2">Contains subcategories</span>
                                <?php elseif($subsubcategory->products->isNotEmpty()): ?>
                                <span class="badge rounded-pill bg-success mt-2"><?php echo e($subsubcategory->products->count()); ?> products</span>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/categories/subsubcategories.blade.php ENDPATH**/ ?>