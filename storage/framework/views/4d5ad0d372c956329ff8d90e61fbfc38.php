        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div class="space-y-6">
                <div class="flex items-center">
                    <img src="<?php echo e(asset('/Images/logofooter.jpg')); ?>" alt="MaxMed Logo" class="h-30 mr-3">
            ...
            <div class="mt-6 lg:mt-0">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo e(route('categories.index')); ?>" class="text-blue-300 hover:text-blue-200">View All Categories →</a></li>
                </ul>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center w-full">
                    <p class="text-gray-400 text-sm">
                        &copy; <?php echo e(date('Y')); ?> MaxMed Scientific & Laboratory Equipment Trading Co L.L.C - All Rights Reserved.
                    </p>
...
</style><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/layouts/footer.blade.php ENDPATH**/ ?>