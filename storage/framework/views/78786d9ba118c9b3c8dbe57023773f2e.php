        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-12">
                <div class="lg:flex items-center bg-white rounded-xl shadow-lg overflow-hidden">
                    <?php if($news[0]->image_url): ?>
                    <div class="lg:w-1/2">
                        <img src="<?php echo e(asset($news[0]->image_url)); ?>" alt="<?php echo e($news[0]->title); ?>" class="h-96 w-full object-cover">
                    </div>
                    <?php endif; ?>
                    <div class="p-8 lg:w-1/2">
                        <div class="flex items-center mb-2">
                            ...
                            <span class="ml-2 text-sm text-gray-500"><?php echo e($news[0]->created_at->format('F d, Y')); ?></span>
                        </div>
                        <h3 class="text-2xl font-bold text-gray-900 mb-4"><?php echo e($news[0]->title); ?></h3>
                        <p class="text-gray-600 mb-6"><?php echo e(Str::limit($news[0]->content, 280)); ?></p>
                        <a href="<?php echo e(route('news.show', $news[0])); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-[#171e60] hover:bg-[#0a5694]">
                            Read Full Article
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($key > 0): ?> <!-- Skip the first item as it's already featured -->
                    <div class="bg-white overflow-hidden shadow-md rounded-xl border border-gray-100 transition-all duration-200 hover:shadow-lg transform hover:-translate-y-1">
                        <?php if($item->image_url): ?>
                            <img src="<?php echo e(asset($item->image_url)); ?>" alt="<?php echo e($item->title); ?>" class="h-48 w-full object-cover">
                        <?php endif; ?>
                        <div class="p-6">
                            <div class="flex items-center mb-2">
                                <span class="text-sm text-gray-500"><?php echo e(formatDubaiDate($item->created_at, 'F d, Y')); ?></span>
                                <!-- Assuming you might have a category field -->
                                <?php if(isset($item->category)): ?>
                                <span class="ml-2 px-2 py-1 text-xs bg-gray-100 text-gray-800 rounded-full"><?php echo e($item->category); ?></span>
                                <?php endif; ?>
                            </div>
                            <h3 class="text-xl font-bold text-gray-900 mb-3"><?php echo e($item->title); ?></h3>
                            <p class="text-gray-600 mb-4"><?php echo e(Str::limit($item->content, 150)); ?></p>
                            <a href="<?php echo e(route('news.show', $item)); ?>" class="text-[#0a5694] hover:text-[#171e60] font-medium flex items-center">
                                Read Article
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/news/index.blade.php ENDPATH**/ ?>