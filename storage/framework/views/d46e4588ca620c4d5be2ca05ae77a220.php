...
<?php $__env->startSection('meta_keywords', $categoryName 
...
<div class="container-fluid mb-5 mt-3 px-3">
                    ...
                    <a href="<?php echo e(route('categories.show', $category)); ?>" class="text-decoration-none">
                        <div class="category-card">
                            ...
                            <div class="overflow-hidden">
                                <img src="<?php echo e($category->image_url); ?>" class="card-img-top" alt="Image of <?php echo e($category->name); ?> category">
                            </div>
                            <div class="card-body">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/products/index.blade.php ENDPATH**/ ?>