...
<?php if($specsByCategory->isNotEmpty()): ?>
<div class="section-card">
    <div class="card-header">
        <h4><i class="fas fa-cogs me-2"></i>Product Specifications</h4>
    </div>
    <div class="card-body">
        <?php $__currentLoopData = $specsByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $specifications): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="specification-category mb-4">
                <?php if($category): ?>
                    <h5 class="category-title mb-3">
                        <i class="fas fa-tag me-2"></i><?php echo e($category); ?>
                ...
                <div class="specifications-grid">
                    <?php $__currentLoopData = $specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="specification-item" data-category="<?php echo e($category); ?>">
                            <div class="spec-label">
                                <?php echo e($spec->display_name); ?>

                                <?php if($spec->description): ?>
                                    <i class="fas fa-info-circle ms-1" 
                                       data-bs-toggle="tooltip" 
                                       data-bs-placement="top" 
                                       title="<?php echo e($spec->description); ?>"></i>
                                <?php endif; ?>
                            </div>
                            <div class="spec-value">
                                <strong><?php echo e($spec->specification_value); ?></strong>
                                <?php if($spec->unit): ?>
                                    <span class="unit"><?php echo e($spec->unit); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php endif; ?> <?php /**PATH C:\Users\Walid\OneDrive\Desktop\MaxMed\resources\views/components/product-specifications.blade.php ENDPATH**/ ?>