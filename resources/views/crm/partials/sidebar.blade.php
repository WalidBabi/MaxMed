<!-- Sidebar component -->
<div class="flex grow flex-col gap-y-5 overflow-y-auto overflow-x-hidden crm-sidebar px-6 pb-4 shadow-lg">
    <!-- Logo -->
    <div class="flex flex-col items-center py-4 min-w-0">
        ...
        <div class="mt-2 text-center min-w-0 w-full px-2">
            <div class="text-xs font-semibold text-gray-600 leading-tight">{{ \App\Helpers\DashboardHelper::crmPortalHeaderName() }}</div>
        </div>
    </div>
