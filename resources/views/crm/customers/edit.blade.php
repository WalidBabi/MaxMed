...
<div class="-mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="{{ route('crm.customers.show', $customer) }}" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                ...
                <a href="{{ route('crm.customers.index') }}" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
                    <svg class="-ml-0.5 mr-1.5 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <!-- Form -->
    <form action="{{ route('crm.customers.update', $customer) }}" method="POST" class="space-y-8">
        @csrf
        @method('PUT')
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        @include('crm.customers.partials.address-fields', [
                            'prefix' => 'billing_',
                            'customer' => $customer
                        ])
                    </div>
        ...
        <div class="flex items-center justify-between pt-6">
            ...
            <div class="flex items-center space-x-4">
                <a href="{{ route('crm.customers.index') }}" class="text-sm font-semibold leading-6 text-gray-900 hover:text-gray-700">Cancel</a>
