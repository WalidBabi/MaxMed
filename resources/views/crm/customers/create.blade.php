...
@section('content')
    ...
    <!-- Form -->
    <form action="{{ route('crm.customers.store') }}" method="POST" class="space-y-8">
        @csrf
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        @include('crm.customers.partials.address-fields', ['prefix' => 'billing_'])
                    </div>
                    ...
                    <div>
                        ...
                        @include('crm.customers.partials.address-fields', ['prefix' => 'shipping_'])
                    </div>
                </div>
            </div>
        </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <textarea name="notes" id="notes" rows="4"
                                  ...
                                  placeholder="Enter any notes about this customer...">{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
