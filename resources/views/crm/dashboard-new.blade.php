        ...
        <div class="card-hover rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <a href="{{ route('admin.quotes.create') }}" class="flex items-center justify-center rounded-lg border border-dashed border-gray-300 p-4 text-sm font-medium hover:border-gray-400 hover:bg-gray-50">
                        <svg class="mr-2 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m6.75 18.75H8.25m0-18.75V9a2.25 2.25 0 002.25 2.25h6.75V8.25a2.25 2.25 0 00-2.25-2.25H10.5V6.75" />
                        </svg>
                        Create Quote
                    </a>
                    <a href="{{ route('admin.customers.create') }}" class="flex items-center justify-center rounded-lg border border-dashed border-gray-300 p-4 text-sm font-medium hover:border-gray-400 hover:bg-gray-50">
                        <svg class="mr-2 h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
