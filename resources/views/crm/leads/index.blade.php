...
// Enhanced send email functionality for leads
document.querySelectorAll('.send-email-btn').forEach(button => {
    button.addEventListener('click', function(e) {
        ...
        if (!assignedUserEmail) {
            alert('This lead does not have an assigned user with an email address.');
            return;
        }
        ...
        if (emailModalCompanyName) emailModalCompanyName.textContent = 'Loading...';
...
console.log('Enhanced CRM Pipeline with Navigation Arrows and Send Email loaded successfully');
</script>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <h4 class="text-sm font-semibold text-gray-900" id="emailModalLeadName">Lead Name</h4>
                                <p class="text-sm text-gray-600" id="emailModalCompanyName">Company Name</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <textarea id="message" 
                                      name="message" 
                                      rows="3"
                                      class="block w-full px-4 py-3 text-gray-900 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none"
            ...
            <div class="bg-gray-50 px-6 py-4 flex items-center justify-between border-t border-gray-200">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <button type="submit" 
                            ...
                            class="px-6 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-lg hover:bg-green-700 flex items-center">
