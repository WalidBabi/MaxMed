                                    ...
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            ...
                                            <div class="mt-2 flex items-center text-xs text-gray-500">
                                                ...
                                                <span>{{ $activity->activity_date->format('M j, Y g:i A') }}</span>
                                                <span class="mr-2">•</span>
                    ...
                    <div class="space-y-3">
                        @foreach($lead->deals as $deal)
                            <div class="border border-gray-200 rounded-lg p-3">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <p class="text-sm font-medium text-gray-900">{{ $deal->deal_name }}</p>
                                        <p class="text-sm text-gray-500">AED {{ number_format($deal->deal_value, 0) }}</p>
                                    </div>
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-{{ $deal->stage_color }}-100 text-{{ $deal->stage_color }}-800">
