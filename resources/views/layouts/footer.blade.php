        ...
        <div class="border-t border-gray-700 mt-8 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
                ...
                <div class="flex space-x-4 mt-4 md:mt-0">
                    <a href="#" class="text-gray-400 hover:text-[#0a5694] transition-colors duration-300">Privacy Policy</a>
                    <a href="#" class="text-gray-400 hover:text-[#0a5694] transition-colors duration-300">Terms of Service</a>
                    <a href="#" class="text-gray-400 hover:text-[#0a5694] transition-colors duration-300">Cookie Policy</a>
                    <a href="#" class="text-gray-400 hover:text-[#0a5694] transition-colors duration-300">Quality Policy</a>
                </div>
            </div>
        </div>
    </div>
