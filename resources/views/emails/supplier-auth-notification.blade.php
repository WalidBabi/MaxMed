                        ...
                        <td style="background-color: #FFFFFF; padding: 40px 30px; text-align: center; border-bottom: 2px solid #171e60;">
                            ...
                            <![endif]-->
                                        ...
                                        <h1 style="margin: 0 0 8px 0; font-size: 28px; font-weight: 600; color: #171e60; letter-spacing: -0.5px;">
                                            {{ $type === 'registered' ? '🏢 New Supplier Registration' : '🔐 Supplier Login Activity' }}
                                        </h1>
                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        <div style="margin-bottom: 20px;">
                                            <div style="font-size: 20px; font-weight: 700; color: #171e60; margin-bottom: 8px; letter-spacing: -0.5px;">🏢 Supplier Information</div>
                                        </div>
