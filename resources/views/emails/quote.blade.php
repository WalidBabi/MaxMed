                ...
                <table class="email-container" cellpadding="0" cellspacing="0" border="0" style="width: 650px; background-color: #FFFFFF; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 30px;">
                            ...
                            <!-- Greeting -->
                            <div style="margin-bottom: 30px;">
                                <h2 style="margin: 0 0 12px 0; font-size: 24px; font-weight: 600; color: #1A202C;">Hello {{ $customer ? $customer->name : $quote->customer_name }},</h2>
                                <p style="margin: 0; font-size: 18px; color: #4A5568; line-height: 1.7;">Thank you for your interest in our products. We've prepared a detailed quote for your consideration.</p>
                            </div>
                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                            <tr>
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; font-weight: 600; color: #4A5568; font-size: 15px;">Quote Number</td>
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; color: #1A202C; text-align: right; font-weight: 500; font-size: 15px;">{{ $quote->quote_number }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; color: #1A202C; text-align: right; font-weight: 500; font-size: 15px;">{{ $quote->reference_number }}</td>
                                            </tr>
                                            @endif
                                            @if($quote->salesperson)
                                            <tr>
                                                <td style="padding: 12px 0; font-weight: 600; color: #4A5568; font-size: 15px;">Salesperson</td>
                                                <td style="padding: 12px 0; color: #1A202C; text-align: right; font-weight: 500; font-size: 15px;">{{ $quote->salesperson }}</td>
                                            </tr>
                                            @endif
                                        </table>
                                    </td>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; margin: 25px 0;">
                                <tr>
                                    <td style="padding: 20px; background-color: #F7FAFC; border-radius: 8px; border-left: 3px solid #48BB78;">
                                        <p style="margin: 0; font-size: 16px; color: #2D3748;"><span style="font-weight: 600; color: #48BB78;">Subject:</span> {{ $quote->subject }}</p>
                                    </td>
                                </tr>
                            </table>
                            @endif
                                ...
                                <tr>
                                    <td style="padding: 20px; text-align: center;">
                                        <div style="font-size: 16px; color: #2B6CB0; font-weight: 600;">
                                            📋 {{ $quote->items->count() }} {{ $quote->items->count() === 1 ? 'Item' : 'Items' }} Included
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; margin: 25px 0;">
                                <tr>
                                    <td style="padding: 20px; background-color: #F0FFF4; border-radius: 8px; border-left: 3px solid #48BB78;">
                                        <div style="color: #2F855A; font-size: 16px; line-height: 1.6;">{{ $quote->customer_notes }}</div>
                                    </td>
                                </tr>
                            </table>
                            @endif
                            ...
                            <div style="margin: 30px 0;">
                                <p style="margin: 0 0 15px 0; color: #4A5568; font-size: 16px; line-height: 1.7;">The detailed quote is attached as a PDF file. If you have any questions or would like to proceed with this quote, please don't hesitate to contact us.</p>
                                <p style="margin: 0; color: #2D3748; font-size: 16px; font-weight: 500;">We look forward to serving you! 🚀</p>
                            </div>
                        </td>
                    </tr>
