...
<head>
    ...
    <title>{{ $isNewLead ? 'New Lead Assigned' : 'Lead Reassigned' }} - {{ $lead->full_name }}</title>
    <!--[if mso]>
    <noscript>
        <xml>
                ...
                <table class="email-container" cellpadding="0" cellspacing="0" border="0" style="width: 650px; background-color: #FFFFFF; border-radius: 12px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.08);">
                        ...
                        <td style="background-color: #FFFFFF; padding: 40px 30px; text-align: center; border-bottom: 2px solid #171e60;">
                            ...
                            <![endif]-->
                                        ...
                                        <h1 style="margin: 0 0 8px 0; font-size: 28px; font-weight: 600; color: #171e60; letter-spacing: -0.5px;">
                                            {{ $isNewLead ? '👥 New Lead Assigned' : '🔄 Lead Reassigned' }}
                                        </h1>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 30px;">
                                    ...
                                    <td style="padding: 25px;">
                                        <div style="margin-bottom: 20px;">
                                            ...
                                            <div style="font-size: 14px; color: #718096;">
                                                ...
                                                @endphp
                                                <span class="status-badge" style="background-color: {{ $priorityColor }};">{{ ucfirst($lead->priority) }} Priority</span>
                                                <span style="margin: 0 8px;">•</span>
                                                <span style="text-transform: capitalize;">{{ str_replace('_', ' ', $lead->status) }}</span>
                                            </div>
                                        </div>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; color: #1A202C; text-align: right; font-weight: 500; font-size: 15px;">
                                                    <a href="mailto:{{ $lead->email }}" style="color: #3182CE; text-decoration: none;">{{ $lead->email }}</a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 12px 0; border-bottom: 1px solid #CBD5E0; color: #1A202C; text-align: right; font-weight: 500; font-size: 15px;">
                                                    <a href="tel:{{ $lead->mobile ?: $lead->phone }}" style="color: #3182CE; text-decoration: none;">{{ $lead->mobile ?: $lead->phone }}</a>
                                                </td>
                                            </tr>
                                            @endif
                                            @endif
                            ...
                            @if(!$isNewLead && ($previousAssignee || $reassignedBy))
                            <!-- Assignment History -->
                                ...
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 0 0 8px 0; color: #451A03; line-height: 1.6;">
                                            <strong>Previous Assignee:</strong> {{ $previousAssignee ? $previousAssignee->name : 'Unassigned' }}
                                        </p>
                                        @if($reassignedBy)
                                        <p style="margin: 0 0 8px 0; color: #451A03; line-height: 1.6;">
                                            <strong>Reassigned By:</strong> {{ $reassignedBy->name }}
                                        </p>
                                        @endif
                                        <p style="margin: 0; color: #451A03; line-height: 1.6;">
                                            <strong>Reassigned On:</strong> {{ now()->format('M j, Y \a\t g:i A') }}
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <!--[if mso]>
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ url('/crm/leads/' . $lead->id) }}" style="height:50px;v-text-anchor:middle;width:250px;" arcsize="20%" strokecolor="#3182CE" fillcolor="#3182CE">
                                        <w:anchorlock/>
