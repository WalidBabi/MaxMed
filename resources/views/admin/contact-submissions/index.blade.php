    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600">Manage and convert contact form submissions to quotation requests</p>
            </div>
        </div>
    </div>
        ...
        <div class="p-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="sales_only" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900">{{ $submissions->total() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-gray-500">Converted to Inquiries</p>
                    <p class="text-lg font-semibold text-gray-900">{{ $submissions->where('status', 'converted_to_inquiry')->count() }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                            ...
                            <div class="flex items-center">
                                <div>
                                    ...
                                    @if($submission->company)
                                        <div class="text-xs text-blue-600">{{ $submission->company }}</div>
                                    @endif
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="text-sm text-gray-500">{{ Str::limit($submission->message, 100) }}</div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($submission->isSalesInquiry())
                                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-green-100 text-green-800">
                                    <i class="fas fa-shopping-cart mr-1"></i>Sales Inquiry
                                </span>
                            @else
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                ...
                                @if($submission->canConvertToInquiry() && $submission->isSalesInquiry())
                                    <span class="text-gray-300">|</span>
                                    <a href="{{ route('admin.contact-submissions.show', $submission) }}#convert" 
                                       class="text-green-600 hover:text-green-900">Convert to Inquiry</a>
                                @endif
                                
                                @if($submission->convertedToInquiry)
                                    <span class="text-gray-300">|</span>
                                    <a href="{{ route('admin.inquiries.show', $submission->convertedToInquiry) }}" 
                                       class="text-purple-600 hover:text-purple-900">View Inquiry</a>
                                @endif
                            </div>
                        </td>
                    </tr>
        ...
        <div class="px-6 py-12 text-center">
            <div class="text-gray-500">
                ...
                <p class="text-sm">Contact form submissions will appear here for management and conversion to inquiries.</p>
                <div class="mt-6">
