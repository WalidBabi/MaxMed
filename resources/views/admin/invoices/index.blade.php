        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $invoices->where('payment_status', 'pending')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ $invoices->where('payment_status', 'paid')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ number_format($invoices->sum('total_amount'), 0) }} AED</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Send Email Modal -->
<div x-data="{ show: false }" x-on:open-modal.window="$event.detail == 'send-invoice-email' ? show = true : null" x-on:close-modal.window="$event.detail == 'send-invoice-email' ? show = false : null" x-show="show" class="fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-50" style="display: none;">
    <div x-show="show" class="fixed inset-0 transform transition-all" x-on:click="show = false" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
        <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
    </div>
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Send Invoice Email</h3>
                        <div class="mt-4 space-y-4">
                            ...
                            <div class="rounded-md bg-blue-50 p-4">
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-blue-700">The invoice PDF will be automatically attached to the email.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
