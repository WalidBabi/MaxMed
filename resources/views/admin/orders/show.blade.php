...
<div class="-mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <!-- Add after the order details section and before the items section -->
            @if($order->requires_quotation)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-lg font-semibold text-gray-900">Quotations</h2>
                        ...
                        @if($order->supplierQuotations->isNotEmpty())
                            <div class="space-y-4">
                                <div class="overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            @foreach($order->supplierQuotations()->latest()->take(3)->get() as $quotation)
                                                <tr>
                        ...
                        @else
                            <div class="text-center py-6">
                                <p class="text-gray-500">No quotations received yet.</p>
                            </div>
                        @endif
                    </div>
                </div>
