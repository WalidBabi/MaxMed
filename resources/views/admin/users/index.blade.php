                                        ...
                                        <div class="flex items-center justify-end space-x-2">
                                            ...
                                            @if($user->id !== Auth::user()->id)
                                                <form
                                                    ...
                                                    data-success-message="User deleted."
                                                    data-success-remove="#user-row-{{ $user->id }}"
                                                >
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="text-red-600 hover:text-red-900" title="Delete User" data-loading-text="Deleting...">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
