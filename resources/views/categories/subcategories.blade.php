...
@section('title', $category->name . ' Categories | MaxMed UAE')
                    ...
                    <a href="{{ $subcategory->hasSubcategories() ? route('categories.subcategory.show', [$category, $subcategory]) : route('categories.subcategory.show', [$category, $subcategory]) }}" class="text-decoration-none">
                        <div class="subcategory-card">
                            ...
                            <div class="card-body">
                                ...
                                @elseif($subcategory->products->isNotEmpty())
                                <span class="badge rounded-pill bg-success mt-2">{{ $subcategory->products->count() }} products</span>
                                @else
