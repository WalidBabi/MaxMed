...
@section('content')
    ...
    <!-- Hero Section -->
    <div class="bg-[#171e60] text-white py-20">
            ...
            <div class="bg-white p-8 rounded-lg shadow-lg">
                ...
                <form x-data="{ submitted: false }" @submit.prevent="submitted = true">
                    <div class="space-y-6">
                        ...
                        <button type="submit" 
                            class="w-full bg-[#171e60] hover:bg-[#0a5694] text-white py-3 rounded-lg transition duration-300">
                            Send Message
                        </button>
                    </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <h3 class="text-xl font-bold mb-4 flex items-center">
                        <svg class="w-6 h-6 mr-2 text-[#171e60]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
